        ...
        try {
            $sql = "
                    select 
                        ...
                        car_Nombre as cargo,
                        upe_matenimiento as umantenimiento,
			upe_usuario as upermiso,
			upe_personal as upersonal,
			upe_incidencia uincidencia,
			upe_conocimiento as uconocimiento,
			upe_area as uarea ,
			upe_cargo as ucargo
                    from 
                        tbusuario u
            ...
            if ($resultado["usu_clave"] == md5($this->getClave())){
                if ($resultado["usu_Estado"] == "I"){
                    ...
                    $_SESSION["pincidencia"]= $resultado["pincidencia"];
                    $_SESSION["pconocimiento"]= $resultado["uconocimiento"];
                    $_SESSION["pdarea"]= $resultado["uarea"];
