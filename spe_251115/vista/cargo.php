...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Mantenimientos de Cargos</title>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <button type="submit" class="btn btn-success" data-toggle="modal" 
                                                    data-target="#myModal" onclick="agregarCargo()">Registrar Cargo
                                            </button>
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-2">
                                            <div class="radio">
                                                <label>
                                                  ...
                                                  <input type="radio" name="marcar" id="marcar" onclick="SeleccionarCargo(1)" value="1">
                                                  <b>Marcar Todos</b>
                                                </label>
                                            </div>                                            
                                        </div>
                                        <div class="col-xs-3">                                            
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="marcar" id="desmarcar"  onclick="SeleccionarCargo(2)"value="2">
                                                  <b>Desmarcar Todos</b>
                                                </label>                                                 
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="pull-right hidden-xs">
                                                <button type="submit" class="btn btn-danger" 
                                                    onclick="EliminarVariosCargos(1)">Eliminar Seleccionados
                                                </button>                                               
                                            </div>    
                                        </div>
                                    </div>
                ...
                <form name="frmgrabar" id="frmgrabar" method="post" action="/">
                    <div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          ...
                          <div class="row">
                              <div class="col-lg-7">
                                  <p><input type="text" name="txtnombre" id="txtnombre" class="form-control" placeholder="Nombre del Cargo" required=""><p>
                              </div>
                          </div>                      
