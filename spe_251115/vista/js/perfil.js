      ...
      var usuario=$("#txtcodusuario").val();
          $.post(
            "../controlador/perfil.controlador.php",
            {
              ...
              $("#txtarea").val(obj.are_nombre);
          });
          
          $.post(
            "../controlador/telefono.controlador.php",
            {
                cod_usuario: usuario
            }
          )
...
//              alert(resultado);
          ...
          $.post(
            "../controlador/correo.controlador.php",
            {
                cod_usuario: usuario
            }
          )
